...
// --- Icons ---
import { BoldIcon } from "@/components/workspace/tiptap/tiptap-icons/bold-icon";
import { Code2Icon } from "@/components/workspace/tiptap/tiptap-icons/code2-icon";
import { ItalicIcon } from "@/components/workspace/tiptap/tiptap-icons/italic-icon";
import { StrikeIcon } from "@/components/workspace/tiptap/tiptap-icons/strike-icon";
import { SubscriptIcon } from "@/components/workspace/tiptap/tiptap-icons/subscript-icon";
import { SuperscriptIcon } from "@/components/workspace/tiptap/tiptap-icons/superscript-icon";
import { UnderlineIcon } from "@/components/workspace/tiptap/tiptap-icons/underline-icon";
