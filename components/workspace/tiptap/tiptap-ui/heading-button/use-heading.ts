...
import {
  ...
  isNodeTypeSelected,
  isValidPosition,
} from "@/lib/TipTapUtils";

// --- Icons ---
import { HeadingOneIcon } from "@/components/workspace/tiptap/tiptap-icons/heading-one-icon";
import { HeadingTwoIcon } from "@/components/workspace/tiptap/tiptap-icons/heading-two-icon";
import { HeadingThreeIcon } from "@/components/workspace/tiptap/tiptap-icons/heading-three-icon";
import { HeadingFourIcon } from "@/components/workspace/tiptap/tiptap-icons/heading-four-icon";
import { HeadingFiveIcon } from "@/components/workspace/tiptap/tiptap-icons/heading-five-icon";
import { HeadingSixIcon } from "@/components/workspace/tiptap/tiptap-icons/heading-six-icon";
