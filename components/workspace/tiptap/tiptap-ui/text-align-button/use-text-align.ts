...
// --- Lib ---
import { isExtensionAvailable, isNodeTypeSelected } from "@/lib/TipTapUtils";

// --- Icons ---
import { AlignCenterIcon } from "@/components/workspace/tiptap/tiptap-icons/align-center-icon";
import { AlignJustifyIcon } from "@/components/workspace/tiptap/tiptap-icons/align-justify-icon";
import { AlignLeftIcon } from "@/components/workspace/tiptap/tiptap-icons/align-left-icon";
import { AlignRightIcon } from "@/components/workspace/tiptap/tiptap-icons/align-right-icon";
