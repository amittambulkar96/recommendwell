                ...
                <div className="mx-auto w-full max-w-7xl px-6">
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                        <Card
                            ...
                            <h3 className="text-foreground mt-5 text-lg font-semibold">Evidence-first letter structure</h3>
                            <p className="text-muted-foreground mt-3 max-w-xl text-balance">Turn bullet notes into a defensible narrative with proof points, outcomes, and context for the reader.</p>
                            <div className="mask-b-from-95% -ml-2 -mt-2 mr-0.5 pl-2 pt-2">
                                <div className="bg-background rounded-tl-(--radius) ring-foreground/5 relative mx-auto mt-8 h-96 overflow-hidden border border-transparent shadow ring-1">
                                    <Image
                                        src="/mist/recommendwell-flow.svg"
                                        alt="Recommendation letter workflow"
                                        width="1600"
                                        height="1000"
                        ...
                        <Card
                            ...
                            <h3 className="text-foreground mt-5 text-lg font-semibold">Tone control presets</h3>
                            <p className="text-muted-foreground mt-3 text-balance">Dial warmth, assertiveness, and specificity without rewriting every paragraph.</p>
                        ...
                        <Card
                            ...
                            <h3 className="text-foreground mt-5 text-lg font-semibold">Bias-aware phrasing</h3>
                            <p className="text-muted-foreground mt-3 text-balance">Real-time language checks flag unintentional bias and keep your letter equitable.</p>
                        ...
                        <Card
                            ...
                            <h3 className="text-foreground mt-5 text-lg font-semibold">Context-aware assistant</h3>
                            <p className="text-muted-foreground mt-3 text-balance">Ask for sharper evidence, shorter drafts, or stronger advocacy without losing voice.</p>
...
const MeetingIllustration = () => {
    return (
        <Card
            ...
            <div className="mb-0.5 text-sm font-semibold">Letter review sync</div>
            ...
            <div className="text-muted-foreground text-sm font-medium">Admissions committee notes</div>
        </Card>
    )
}
    ...
    return (
        <Card
            ...
            <div className="w-fit">
                ...
                <p className="mt-2 line-clamp-2 text-sm">How can I highlight leadership and research impact in paragraph two?</p>
            </div>
            <div className="bg-foreground/5 -mx-3 -mb-3 mt-3 space-y-3 rounded-lg p-3">
                <div className="text-muted-foreground text-sm">Ask RecommendWell</div>
